...
<div class="container-fluid">
    <div class="row">
        <div class="col-8">
            <h1 class="center mb-3">FormTambah Pasien</h1>
                    ...
                    <div class="form-group row mb-2">
                        ...
                        <div class="col-5">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="inlineRadioOptions" id="opPria" value="Pria">
                                <label class="form-check-label" for="opPria">Pria</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="inlineRadioOptions" id="opWanita" value="Wanita">
