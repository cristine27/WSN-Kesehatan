    ...
    <div class="container">
        <div class="row">
            <div class="col">
                ...
                <!-- Modal -->
                <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="<?= ($flag == true) ? "true" : "true" ?>">
